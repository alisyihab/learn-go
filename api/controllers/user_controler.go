...
import (
	...
	"github.com/alisyihab/learn-go/api/auth"
	"github.com/alisyihab/learn-go/api/models"
	"github.com/alisyihab/learn-go/api/security"
	"github.com/alisyihab/learn-go/api/utils/fileformat"
	"github.com/alisyihab/learn-go/api/utils/formaterror"
...
func (server *Server) UpdateAvatar(c *gin.Context) {
	...
	path := "upload/profile-photos/" + filePath
